...
def remove_edge(adjacency_matrix, u, v):
    """
...
def restore_edge(adjacency_matrix, u, v, weight):
    """
    ...
    u (int): The index of the source node.
    v (int): The index of the target node.
    weight (int): The weight of the edge to be restored.
...
def yen_ksp(adjacency_matrix, source, sink, K):
    """
